    ...
    <section id="fleet" className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="font-bold text-3xl md:text-4xl mb-4">Our Vehicle Fleet</h2>
        ...
        <div className="mt-10 text-center">
          <Link href="#fleet" className="inline-flex items-center text-primary font-medium hover:underline">
